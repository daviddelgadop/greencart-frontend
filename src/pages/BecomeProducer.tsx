    ...
    <main className="min-h-screen bg-white font-poppins">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <h3 className="text-xl font-semibold mb-2">Réduction des pertes</h3>
              <p className="text-gray-700">Transformez vos invendus en opportunité économique.</p>
            </div>

            <div>
              <Users className="w-10 h-10 mx-auto mb-4 text-dark-green" />
              <h3 className="text-xl font-semibold mb-2">Nouvelle clientèle</h3>
              <p className="text-gray-700">Touchez des consommateurs engagés et fidèles.</p>
            </div>

            <div>
              <Leaf className="w-10 h-10 mx-auto mb-4 text-dark-green" />
              <h3 className="text-xl font-semibold mb-2">Engagement responsable</h3>
              <p className="text-gray-700">Valorisez votre démarche durable et locale.</p>
            </div>
      ...
      <section className="py-20 bg-dark-green text-pale-yellow text-center">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-6">Rejoignez le réseau de producteurs GreenCart</h2>
          <p className="text-lg mb-8 text-pale-yellow/90">L’inscription est simple et gratuite.</p>
          <Link
            to="/register?type=producer"
