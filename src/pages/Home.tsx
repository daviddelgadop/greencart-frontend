  ...
  return (
    <div className="min-h-screen pt-28">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              {/* ✅ H2 CORRECT */}
              <h2 className="text-2xl md:text-3xl font-medium mb-8 text-pale-yellow/90">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12 text-dark-green">
      ...
      {/* SECTION TÉMOIGNAGES (optionnel, décommenté si besoin) */}
      {/*
      <section className="py-20 bg-pale-yellow/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
